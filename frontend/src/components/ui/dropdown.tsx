...
const DropdownSelector = React.forwardRef<HTMLSelectElement, Props>(
  ({ name, labelKey, options, errorKey, selectedItem, setSelectedItem }) => {
          ...
          {({ open }) => (
            <div className='relative ltr:ml-2 rtl:mr-2 ltr:lg:ml-0 rtl:lg:mr-0 z-10 min-w-[180px]'>
              ...
              >
                <Listbox.Options
                  static
                  className='w-full py-1 mt-1 overflow-auto bg-white rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none text-sm'
                >
